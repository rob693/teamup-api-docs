# Endpoints_Discount Codes Deactivate All Create

**Method:** POST
**URL:** `/api/v2//discount_codes/deactivate_all`

## Summary
Deactivate All Discount Codes | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//discount_codes/deactivate_all
