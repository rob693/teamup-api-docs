# Endpoints_Discount Codes Activate All Create

**Method:** POST
**URL:** `/api/v2//discount_codes/activate_all`

## Summary
Activate All Discount Codes | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//discount_codes/activate_all
