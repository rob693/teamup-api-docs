# Endpoints_Communication Broadcast Messages Send Create

**Method:** POST
**URL:** `/api/v2//communication/broadcast_messages/`

## Summary
Send | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//communication/broadcast_messages/:id/send
