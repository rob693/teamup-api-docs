# Endpoints_Communication Broadcast Messages Partial Update
...
PATCH https://goteamup.com/api/v2//communication/broadcast_messages/:id
...
Possible values: [marketing, general]Bodymessagestringuse_casestring
Possible values: [marketing, general]Bodymessagestringuse_casestring
Possible values: [marketing, general]
...
```json
{  "message": "string",  "use_case": "marketing"}
```
