# Endpoints_Customers Bulk Delete Create

**Method:** POST
**URL:** `/api/v2//customers/bulk_delete`

## Summary
Bulk Delete | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//customers/bulk_delete
