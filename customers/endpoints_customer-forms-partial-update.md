# Endpoints_Customer Forms Partial Update

**Method:** PATCH
**URL:** `/api/v2//customer_forms/`

## Summary
Partially Update Customer Form | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

PATCH https://goteamup.com/api/v2//customer_forms/:id
