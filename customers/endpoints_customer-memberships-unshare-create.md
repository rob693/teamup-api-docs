# Endpoints_Customer Memberships Unshare Create

**Method:** POST
**URL:** `/api/v2//customer_memberships/`

## Summary
Unshare | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//customer_memberships/:id/unshare
