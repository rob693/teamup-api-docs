# Endpoints_Fees Calculator Create

**Method:** POST
**URL:** `/api/v2//fees_calculator`

## Summary
Calculate Fees | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//fees_calculator
...
```json
{  "pre_tax_price": "10.99",  "post_tax_price": "10.99",  "purchase_type": "event"}
```
