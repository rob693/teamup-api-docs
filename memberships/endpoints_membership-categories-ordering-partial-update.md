# Endpoints_Membership Categories Ordering Partial Update

**Method:** PATCH
**URL:** `/api/v2//membership_categories/ordering`

## Summary
Reorder | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

PATCH https://goteamup.com/api/v2//membership_categories/ordering
