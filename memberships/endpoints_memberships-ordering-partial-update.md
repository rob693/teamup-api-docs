# Endpoints_Memberships Ordering Partial Update

**Method:** PATCH
**URL:** `/api/v2//memberships/ordering`

## Summary
Ordering | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

PATCH https://goteamup.com/api/v2//memberships/ordering
