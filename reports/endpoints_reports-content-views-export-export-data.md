# Endpoints_Reports Content Views Export Export Data

**Method:** GET
**URL:** `/api/v2//reports/content_views/export`
...
POST https://goteamup.com/api/v2//reports/content_views/export
