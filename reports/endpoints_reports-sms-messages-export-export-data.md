# Endpoints_Reports Sms Messages Export Export Data

**Method:** GET
**URL:** `/api/v2//reports/sms_messages/export`
...
POST https://goteamup.com/api/v2//reports/sms_messages/export
