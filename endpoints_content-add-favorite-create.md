# Endpoints_Content Add Favorite Create

**Method:** POST
**URL:** `/api/v2//content/`

## Summary
Add Favorite | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//content/:id/add_favorite
