# Endpoints_Business Closures Bulk Close Create

**Method:** POST
**URL:** `/api/v2//business_closures/bulk_close`

## Summary
Bulk Close | TeamUp Developers

## Request Parameters
(Heuristically extracted. Refine as needed.)

POST https://goteamup.com/api/v2//business_closures/bulk_close
