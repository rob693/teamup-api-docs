# Endpoints_Availability Schedules List
...
GET https://goteamup.com/api/v2//availability_schedules
...
```json
{  "count": 123,  "next": "http://api.example.org/accounts/?page=4",  "previous": "http://api.example.org/accounts/?page=2",  "results": [    {      "id": 0,      "name": "string",      "venue": 0,      "default_monday": [        {          "start": "string",          "end": "string"        }
```
