# Endpoints_Checkouts Partial Update
...
PATCH https://goteamup.com/api/v2//checkouts/:id
...
application/jsonapplication/x-www-form-urlencodedmultipart/form-dataBodycustomerintegerdiscount_codestringnullablePossible values: non-emptyreturn_tostringnullablePossible values: non-empty and &lt;= 1000 charactersuse_account_creditbooleanBodycustomerintegerdiscount_codestringnullablePossible values: non-emptyreturn_tostringnullablePossible values: non-empty and &lt;= 1000 charactersuse_account_creditbooleanBodycustomerintegerdiscount_codestringnullablePossible values: non-emptyreturn_tostringnullablePossible values: non-empty and &lt;= 1000 charactersuse_account_creditboolean
...
```json
{  "customer": 0,  "discount_code": "string",  "return_to": "string",  "use_account_credit": True}
```
